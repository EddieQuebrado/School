...
/**
 * Single based implementation of IndexUnsortedList.
...
public class IUSingleLinkedList<T> implements IndexedUnsortedList<T> {
	...
	@Override
	/**
	 * Adds element to the list, element will
	 * be added to the end.
	 */
	...
	@Override
	/**
	 * Adds an element after first occurence of target element.
	 */
	...
	@Override
	/**
	 * Removes that last element of the list.
	 */
	public T removeLast() {
		if(isEmpty()) {
			throw new NoSuchElementException();
	...
	@Override
	/**
	 * Removes first occurence of the target element.
