...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(A_removeFirst_emptyList, "A_removeFist_emptyList");
		...
		testEmptyList(A_iterRemoveAfterNextA_emptyList, "A_iteratorRemoveAfterNextA_emptyList");
		if(SUPPORTS_LIST_ITERATOR) {
			testEmptyList(A_listIter1RemoveAfterPrevious_emptyList, "A_listIterRemoveAfterPrevious_emptyList");
		...
		if(SUPPORTS_LIST_ITERATOR) {
			...
			testSingleElementList(AB_listIter2RemoveAfterPrevious_A, "AB_listIter1RemoveAfterPrevious_A", LIST_A, STRING_A);
		...
		testThreeElementList(AB_addToRearC_ABC, "AB_addToRear_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(AB_addAfterCA_ACB, "AB_addAfterAC_ACB", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_addAfterCB_ABC, "AB_addAfterBC_ABC", LIST_ABC, STRING_ABC);
		...
		if(SUPPORTS_LIST_ITERATOR) {
			testThreeElementList(AB_ListIterAddAfterNextC_CAB, "AB_ListIterRemoveAfterNextC_CAB", LIST_CAB, STRING_CAB);
			testThreeElementList(AB_ListIterAddAfterNextC_ACB, "AB_ListIterRemoveAfterNextC_ACB", LIST_ACB, STRING_ACB);
			testThreeElementList(AB_ListIterAddAfterNextC_ABC, "AB_ListIterRemoveAfterNextC_ABC", LIST_ABC, STRING_ABC);
			testThreeElementList(AB_ListIterAddAfterPrevC_CAB, "AB_ListIterRemoveAfterPrevC_CAB", LIST_CAB, STRING_CAB);
		...
		testThreeElementList(ABC_set2D_ABD, "ABC_set1D_ABD", LIST_ABD, STRING_ABD);
		if(SUPPORTS_LIST_ITERATOR) {
...
//			break;
	 ...
	 * @return [B,C] after iteratorRemoveAfterNextB
	 */
	 ...
	 * @return [A,C] after iterartorRemoveAfterNextB
	 */
	 ...
	 * @return [A,B] after iterartorRemoveAfterNextC
	 */
	...
	//////////////////////////////////
	////// XXX ListIterator Remove Scenarios
	//////////////////////////////////
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterNextRemoveNext(scenario.build()), Result.False)); 
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterNextRemoveNext(scenario.build()), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterNextRemoveNext(scenario.build()), Result.NoException));
			if (SUPPORTS_LIST_ITERATOR) {
				  printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
			      printTest(scenarioName + "_testListIterNeg1", testListIter(scenario.build(), -1, Result.IndexOutOfBounds));
			      printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.NoException));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterNextRemoveNext(scenario.build()), Result.True)); 
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterNextRemoveNext(scenario.build()), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterNextRemoveNext(scenario.build()), Result.NoException));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext", testIterHasNext(iterNextNextRemoveNext(scenario.build()), Result.False));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext", testIterNext(iterNextNextRemoveNext(scenario.build()), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove", testIterRemove(iterNextNextRemoveNext(scenario.build()), Result.NoException));
			if (SUPPORTS_LIST_ITERATOR) {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.NoException));
			      printTest(scenarioName + "_testListIterNeg1", testListIter(scenario.build(), -1, Result.IndexOutOfBounds));
			      printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.NoException));
	...
	/** Helper for testing iterators. Return an Iterator that has had next() remove() next().
	 * @param list
	 * @return Iterator for given list
	 */
	...
	/** Helper for testing iterators. Return an Iterator that has had next() next() remove()
	 * next().
	 * @param list
	 * @return Iterator for given list
	 */
