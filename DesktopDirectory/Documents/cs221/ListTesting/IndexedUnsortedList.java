...
/**
 *  Interface (ADT) for an Iterable, Indexed, Unsorted List.
 *  Behavior is expected to be consistent with the List interface
 *  from the Java Collections API (java.util.List).
